...
Synthetic previews: [credit policy](screenshots/admin-policy.png), [workflow details](screenshots/admin-workflow-detail.png), [mobile](screenshots/admin-mobile.png).

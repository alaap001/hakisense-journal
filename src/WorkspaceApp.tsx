...
export default function WorkspaceApp(){
  ...
  useLayoutEffect(()=>{setMobile(false);window.scrollTo(0,0);},[location.pathname]);
  useEffect(()=>{const listener=(e:KeyboardEvent)=>{if((e.metaKey||e.ctrlKey)&&e.key==='j'){if(document.querySelector('dialog[open]'))return;e.preventDefault();edit('new');}};window.addEventListener('keydown',listener);return()=>window.removeEventListener('keydown',listener);},[edit]);
  useEffect(()=>{
